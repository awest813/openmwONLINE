#define SHADOWS @shadows_enabled
    ...
    @foreach shadow_texture_unit_index @shadow_texture_unit_list
        ...
        in vec4 shadowSpaceCoords@shadow_texture_unit_index;

#if @perspectiveShadowMaps
        in vec4 shadowRegionCoords@shadow_texture_unit_index;
#endif
    @endforeach
#endif // SHADOWS
...
float unshadowedLightRatio(float distance)
{
    ...
    @foreach shadow_texture_unit_index @shadow_texture_unit_list
        if (!doneShadows)
        {
            ...
            {
                shadowing = min(textureProj(shadowTexture@shadow_texture_unit_index, shadowSpaceCoords@shadow_texture_unit_index).r, shadowing);
